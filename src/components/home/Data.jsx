...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Vinicius Nascimento
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Development Student</h3>
            <p className="home__description">Hello! You can call me Vini, I'm 26 years old and currently a university student of systems analysis and development, i'm looking for an internship opportunity in the technology area.</p>
